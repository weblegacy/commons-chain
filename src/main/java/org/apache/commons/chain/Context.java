 ...
 * required and optional contracts of the {@code java.util.Map}
 * interface.</p>
 *
 ...
 * a value stored via a call to {@code setFoo(value)} should be visible
 * by calling {@code get("foo")}, and a value stored
 * via a call to {@code put("foo", value)} should be
 * visible by calling {@code getFoo()}. If your {@link Context}
 * implementation class exhibits this feature, it becomes easier to reuse the
